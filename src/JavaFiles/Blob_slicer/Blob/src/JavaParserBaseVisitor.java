// Generated from D:/\JavaParser.g4 by ANTLR 4.8
...
public class JavaParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements JavaParserVisitor<T> {
	 ...
	 * @return
	 */
	@Override public T visitTypeDeclaration(JavaParser.TypeDeclarationContext ctx) {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitClassDeclaration(JavaParser.ClassDeclarationContext ctx) {
		if(ctx.getParent().getRuleIndex() == JavaParser.RULE_typeDeclaration){
			Blob.ClassName="";
			Blob.ClassName = ctx.IDENTIFIER().toString();
			Blob.class_counter++;
		}
		return visitChildren(ctx);
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitMethodDeclaration(JavaParser.MethodDeclarationContext ctx) {
		Blob.methodTemporaryContext="";
		Blob.methodTemporaryContext= ctx.getText();
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitQualifiedName(JavaParser.QualifiedNameContext ctx) {
		if(ctx.getParent().getRuleIndex()==JavaParser.RULE_packageDeclaration) {
			Blob.packageName = "";
			Blob.packageName = ctx.getText();
		}
